...
class TrainDSLSpec extends WordSpec with Matchers {
  ...
  "Creating a Train starting with a TrainInfo" should {
    "return a properly initialized Train" in {
      (InterCityExpress(724) at ice724MunichTime from munich at ice724NurembergTime from nuremberg) shouldEqual
  ...
  "Creating a Train starting with a Train" should {
    "return a properly initialized Train" in {
      (InterCityExpress(724) at ice724MunichTime from munich at ice724NurembergTime from nuremberg at ice724FrankfurtTime from frankfurt) shouldEqual
